...
const History = () => {
  ...
  return (
    ...
    <p className='text-lightBlue ml-1 font-kanit'>({list.length +1 } battles)</p>
    </div>
    <div>
    ...
    <div className='flex p-2 border-borderBlue border rounded-xl justify-between items-center font-kanit mt-1'>
            <div>1.</div>
            <div><p className='text-lightBlue'>Date</p><h1>2024-1-1</h1></div>
            <div><p className='text-lightBlue'>Time</p> <h1>12:00 AM</h1></div>
        ...
        </div>
      {
        list.map((item,index)=>(
            ...
            <div><p className='text-lightBlue'>Date</p><h1>{item.date}</h1></div>
            <div><p className='text-lightBlue'>Time</p> <h1>{item.time}</h1></div>
            <div><img src={line} alt="" /></div>
            <div><img className='h-15' src={item.pokemonImage} alt="" /></div>
            <div><h1>{item.pokemonName}</h1></div>
            <div><img className='h-14' src={vs} alt="" /></div>
            <div><h1>{item.pokemonName2}</h1></div>
            <div><img src={item.pokemonImage2} alt="" /></div>
            <div><img  src={line} alt="" /></div>
            <div><h1 >Winner</h1></div>
            <div><img src={winner} alt="" /></div>
            <div><img src={item.win===item.pokemonName?item.pokemonImage:item.pokemonImage2} alt="" /></div>
        </div>
